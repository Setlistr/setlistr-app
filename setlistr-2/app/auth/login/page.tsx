        ...
        {!showWaitlist ? (
          <div style={{ animation: 'fadeUp 0.4s ease' }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: 13, fontWeight: 600, color: C.secondary, margin: '0 0 5px' }}>
                Not a member yet?
              </p>
            ...
            <div style={{
              ...
              {waitlistDone ? (
                <div style={{ textAlign: 'center', padding: '16px 0' }}>
                  ...
                  <h2 style={{ fontSize: 20, fontWeight: 800, color: C.text, margin: '0 0 8px', letterSpacing: '-0.02em' }}>
                    You're on the list!
                  </h2>
                ...
                <>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                    <div>
                      ...
                      <input
                        type="text" value={waitlistName}
                        onChange={e => setWaitlistName(e.target.value)}
                        placeholder="e.g. John Smith"
                        style={inputStyle(waitlistName)}
                        onFocus={e => (e.target as HTMLInputElement).style.borderColor = 'rgba(201,168,76,0.4)'}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="you@example.com"
                        style={inputStyle(waitlistEmail)}
                        onFocus={e => (e.target as HTMLInputElement).style.borderColor = 'rgba(201,168,76,0.4)'}
                    ...
                    <button
                      ...
                      style={{
                        width: '100%', padding: '13px',
                        background: waitlistEmail.trim() ? C.gold : C.muted,
                        border: 'none', borderRadius: 10,
                        color: '#0a0908', fontSize: 13, fontWeight: 800,
                        letterSpacing: '0.08em', textTransform: 'uppercase',
                        cursor: waitlistLoading || !waitlistEmail.trim() ? 'not-allowed' : 'pointer',
                        opacity: waitlistLoading ? 0.7 : 1,
                        transition: 'all 0.2s ease', fontFamily: 'inherit', marginTop: 4,
                        display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
                      }}
                    >
                      {waitlistLoading ? (
